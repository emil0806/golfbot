...
def stabilize_detections(current_balls, robot_px, distance_threshold=10):
    """
    - Tilføjer en bold som 'stabil', hvis den er set i mindst 10 af de seneste frames.
    - En stabil bold fjernes hvis:
        (1) robotten har været tæt på og bolden derefter er uset i 3 frames, eller
        (2) bolden har været helt væk i 10 frames.
    """
